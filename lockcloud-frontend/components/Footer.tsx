  ...
  return (
    <footer className="bg-white border-t border-gray-200 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 md:py-4">
        ...
        <div className="flex flex-col items-center justify-center gap-1.5 text-xs text-gray-600 md:hidden">
          <div className="flex items-center gap-2">
            <span>© {new Date().getFullYear()}</span>
            <span className="text-gray-300">·</span>
            <span className="font-medium text-orange-500">Hofmann</span>
            <span className="text-gray-300">·</span>
            <a
              href="https://github.com/Hofmann8/lockcloud"
              target="_blank"
        ...
        {/* Desktop Layout */}
        <div className="hidden md:flex flex-col lg:flex-row justify-between items-center gap-3 text-xs text-gray-600">
